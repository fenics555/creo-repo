...
system: Creo
description: Use when: подраздел STANDARDS темы Creo — указатель на скиллы
when: creo, стандарты КБ, имена, шаблоны, чертежи, параметры, карточки
priority: medium

# ПОДРАЗДЕЛ STANDARDS (тема Creo)
Вход темы — главный индекс: `..\SKILL_creo_index.md`.
